  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      children: [
        { 
          id: 'manajemen-tanam', 
          label: 'Manajemen Tanam', 
          icon: (
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h2a2 2 0 002-2z" />
            </svg>
          ),
          path: '/aktivitas-tanam-petani/manajemen-tanam' 
        },
        { 
    ...
    <div className={`h-screen bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 flex flex-col ${
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          {!isCollapsed && (
            <div className="flex items-center">
              <div className="w-9 h-9 bg-emerald-400 dark:bg-emerald-200 rounded-lg flex items-center justify-center">
                <img src="/favicon-192.svg" alt="TTS Logo" className="w-8 h-8" />
              </div>
              <div className="ml-3">
                <h1 className="text-lg font-semibold text-gray-900 dark:text-white">TTS</h1>
                <p className="text-xs text-gray-500 dark:text-gray-400">Tobacco Traceability System</p>
              </div>
            </div>
          )}
          <button
