  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        {/* Modal */}
        <div className="relative inline-block align-bottom bg-white dark:bg-gray-800 rounded-xl text-left shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full max-h-[90vh] overflow-y-auto z-10">
          {/* Header */}
          ...
          <div className="p-6">
            ...
            <div className={`space-y-6 ${activeTab === 'info' ? 'block' : 'hidden'}`}>
                {/* Profile Summary */}
                <div className="bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 rounded-lg p-4">
                  <div className="flex items-center">
                ...
                <div className="bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 p-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                      <div className="flex items-center">
                        <div className="w-8 h-8 bg-green-400 dark:bg-green-900 rounded-full flex items-center justify-center mr-3">
                          <svg className="w-4 h-4 text-green-500 dark:text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          </svg>
                        </div>
                        <span className="text-sm font-medium text-black-900 dark:text-green-300">KTP</span>
                      </div>
                    </div>
                        ...
                        <button
                          ...
                          className={`p-4 rounded-lg border-2 transition-all duration-200 ${
                            decision === 'suspended'
                              ...
                              : 'border-gray-300 dark:border-gray-600 hover:border-amber-400 dark:hover:border-amber-700 text-gray-800 dark:text-gray-300 bg-white dark:bg-gray-800'
                          }`}
                        >
                          <div className="text-center">
