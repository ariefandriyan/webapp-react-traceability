    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-xl text-left shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full max-h-[90vh] overflow-y-auto">
          ...
          {/* Content */}
          <div className="p-6" style={{ backgroundColor: '#f8fafc', minHeight: '300px' }}>
            {/* Debug Info */}
            <div className="mb-4 p-3 bg-yellow-200 border-2 border-yellow-400 rounded text-sm font-mono">
              <strong>DEBUG INFO:</strong><br/>
              • Active Tab: <span className="text-blue-600">{activeTab}</span><br/>
              • Registration: <span className="text-green-600">{registration ? 'LOADED ✓' : 'NULL ✗'}</span><br/>
              • Modal Open: <span className="text-purple-600">{isOpen ? 'TRUE ✓' : 'FALSE ✗'}</span>
            </div>
            ...
            {/* Decision Tab */}
            <div 
              className={`space-y-6 ${activeTab === 'decision' ? 'block' : 'hidden'}`}
              style={{ 
            ...
            >
              <h2 className="text-xl font-bold text-green-600 mb-4">
                ⚖️ DECISION TAB - VISIBILITY TEST
              </h2>
                {/* Quick Stats */}
